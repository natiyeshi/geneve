        ...
        <div className="relative h-[70vh]">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="container mx-auto text-center">
              ...
              {/* <p className="text-xl text-white/90 max-w-2xl mx-auto slide-up mb-8">
              ...
              <div className="flex flex-wrap justify-center items-center gap-10 mt-12">
                ...
                >
                  ...
                  <p className="text-sm font-medium text-white mt-2 text-center">WhatsApp</p>
                </a>
                ...
                >
                  ...
                  <p className="text-sm font-medium text-white mt-2 text-center">Telegram</p>
                </a>
                ...
                >
                  ...
                  <p className="text-sm font-medium text-white mt-2 text-center">Email</p>
                </a>
                ...
                >
                  ...
                  <p className="text-sm font-medium text-white mt-2 text-center">Phone</p>
                </a>
              </div>
            </div>
          </div>
