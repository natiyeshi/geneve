      ...
      <section className="py-24 bg-gradient-to-b from-white to-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-lg mx-auto mb-24 bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            <h3 className="text-2xl font-medium text-[#09163A] mb-6 text-center">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="space-y-6">
                  <div className="bg-gray-50 p-6 rounded-xl hover:bg-gray-100 transition-colors duration-300">
                    <p className="font-medium text-lg text-[#09163A] mb-2">
                      {t("contact.offices.addis.title")}
                    </p>
                    <p className="text-gray-600">
                      {t("contact.offices.addis.address1")}
                    </p>
                    <p className="text-gray-600">
                      {t("contact.offices.addis.address2")}
                    </p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-xl hover:bg-gray-100 transition-colors duration-300">
                    <p className="font-medium text-lg text-[#09163A] mb-2">
                      {t("contact.offices.dubai.title")}
                    </p>
                    <p className="text-gray-600">
                      {t("contact.offices.dubai.address1")}
                    </p>
                    <p className="text-gray-600">
                      {t("contact.offices.dubai.address2")}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                  ...
                  <div className="bg-gray-50 p-6 rounded-xl hover:bg-gray-100 transition-colors duration-300">
                    <p className="text-gray-600 text-lg mb-2">
                      {t("contact.businessHours.onlineSupport")}:{" "}
                      <span className="font-medium text-[#09163A]">24/7</span>
                    </p>
                    <p className="text-gray-600 text-lg">
                      {t("contact.businessHours.officeHours")}:{" "}
                      <span className="font-medium text-[#09163A]">
                        2:30 PM - 11:30 PM
                      </span>
                    </p>
                  </div>
                  ...
                  <div className="bg-gray-50 p-6 rounded-xl hover:bg-gray-100 transition-colors duration-300">
                    <p className="flex items-center mb-4">
                      ...
                      <a
                        ...
                        className="text-[#EE1D46] hover:text-[#EE1D46]/80 transition-colors duration-300"
                      >
                        +251 98 911 1111
                      </a>
                    </p>
                    <p className="flex items-center">
                      <span className="font-medium text-lg mr-2">
                        {t("contact.contactDetails.email")}:
                      </span>
                      <a
